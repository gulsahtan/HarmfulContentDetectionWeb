...
using HarmfulContentDetection.Authorization.Users;
using HarmfulContentDetection.Controllers;
using HarmfulContentDetection.Identity;
using HarmfulContentDetection.MultiTenancy;
using HarmfulContentDetection.Sessions;
using HarmfulContentDetection.Web.Models.Account;
using HarmfulContentDetection.Web.Views.Shared.Components.TenantChange;

namespace HarmfulContentDetection.Web.Controllers
{
    public class AccountController : HarmfulContentDetectionControllerBase
    {
